...
assert_true(str_contains($javascript, 'await waitFor(() => OneSignal.User.externalId === oneSignalUser'), 'push diagnostics wait until OneSignal exposes the linked external user ID');
